// Jquery Count To
!function(t){t.fn.countTo=function(e){return e=e||{},t(this).each(function(){var a=t.extend({},t.fn.countTo.defaults,{from:t(this).data("from"),to:t(this).data("to"),speed:t(this).data("speed"),refreshInterval:t(this).data("refresh-interval"),decimals:t(this).data("decimals"),separator:t(this).data("separator")},e),r=Math.ceil(a.speed/a.refreshInterval),n=(a.to-a.from)/r,o=this,l=t(this),s=0,i=a.from,f=l.data("countTo")||{};function c(t){var e=a.formatter.call(o,t,a);l.text(e)}l.data("countTo",f),f.interval&&clearInterval(f.interval),f.interval=setInterval(function(){s++,c(i+=n),"function"==typeof a.onUpdate&&a.onUpdate.call(o,i);s>=r&&(l.removeData("countTo"),clearInterval(f.interval),i=a.to,"function"==typeof a.onComplete&&a.onComplete.call(o,i))},a.refreshInterval),c(i)})},t.fn.countTo.defaults={from:0,to:0,speed:1e3,refreshInterval:100,decimals:0,formatter:function(t,e){return function(t,e){x=(e+="").split("."),x1=x[0],x2=x.length>1?"."+x[1]:"";var a=/(\d+)(\d{3})/;for(;a.test(x1);)x1=x1.replace(a,"$1"+t.separator+"$2");return x1+x2}(e,t.toFixed(e.decimals))},separator:",",onUpdate:null,onComplete:null}}(jQuery);
