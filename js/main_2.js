...
$(".ajax_add_to_cart").on('click', function (e) {
	...
	$(".apress_cart_sidebar_modal").addClass("cart_sidebar_open");
	$(".apress_cart_sidebar_modal_mask").addClass("apress_cart_sidebar_modal_maskopen");
})
	
$(".apress_modal_close_button, .apress_cart_sidebar_modal_mask").on('click', function (e) {
	
	$('.apress_cart_sidebar_modal').addClass('out_anim' );
	setTimeout(function() {
		$(".apress_cart_sidebar_modal").removeClass("cart_sidebar_open").removeClass("out_anim");
		$(".apress_cart_sidebar_modal_mask").removeClass("apress_cart_sidebar_modal_maskopen");
	}, 350);
